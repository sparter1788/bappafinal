...
<?php  /*if(is_single()){
	...
	$key_valuesArr = get_post_meta( get_the_ID(), '_yoast_wpseo_focuskw');
	print_r($key_valuesArr);
	$arr=explode(',',$key_valuesArr[0]);
	print_r($arr);
	foreach ($arr as $key => $value) {
		echo '<meta property="article:tag" content="'.$value.'" />';
	}
}*/
