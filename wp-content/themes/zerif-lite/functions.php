...
function zerif_scripts() {    
    ...
    wp_enqueue_script('parallax',get_template_directory_uri() . '/parallax/jquery.min.js', array(), '20120206', true);
    wp_enqueue_script('parallaxjs',get_template_directory_uri() . '/parallax/parallax.js', array(), '20120206', true);
