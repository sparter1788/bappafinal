...
<div class="container">
	...
	<?php
				...
				echo '<div class="'.$footer_class.' company-details">';
					...
					if( !empty($zerif_email) ) {
						echo '<div class="zerif-footer-email">';	
							echo 'support@bappabloggers.com';
						echo '</div>';
					} else if( isset( $wp_customize ) ) {
		...
		!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
					...
					echo '<div class="zerif-copyright-box"><a class="zerif-copyright" href="'.site_url().'" rel="nofollow">BappaBloggers </a> powered by  <a class="zerif-copyright" href="'.site_url().'" rel="nofollow">Developer Team</a></div>';
...
/*	$('#testimonials').parallax({imageSrc: "http://www.bappabloggers.com/wp-content/uploads/2017/02/Astronaut-in-Space-HD-Wallpaper.jpg"});*/
	$('#contact').parallax({imageSrc: "http://www.bappabloggers.com/wp-content/uploads/2017/02/Astronaut-in-Space-HD-Wallpaper.jpg"});
    </script>