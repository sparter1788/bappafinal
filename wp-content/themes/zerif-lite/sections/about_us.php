...
<li class="skill skill_5">
					...
					<div class="skill-count"><div style="display: inline; width: 64px; height: 200px; margin-left: -63px;"><canvas width="64" height="200"></canvas><input type="text" value="99" data-thickness=".2" class="skill2" tabindex="-1" readonly="readonly" style="width: 36px; height: 21px; position: absolute; vertical-align: middle; margin-top: 21px; margin-left: -50px; border: 0px; font-style: normal; font-variant: normal; font-weight: bold; font-stretch: normal; font-size: 12px; line-height: normal; font-family: Arial; text-align: center; color: rgb(255, 255, 255); padding: 0px; -webkit-appearance: none; background: none;"></div></div><div class="section-legend">Project Analysis</div>
					<p> Our team is highly skilled and experienced and they are good in analysing the project requirements.</p>
				</li>
