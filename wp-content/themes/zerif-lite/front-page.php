...
<!-- custom section  for projects starts -->

<section id="latest-projects" class="latest-projects">
	<div class="container">
		<div class="section-header">
			<h2 class="white-text">Latest Projects</h2>
		</div>
		<!-- END .section-header -->
		<div class="clear"></div>
		<div data-ride="carousel" class="carousel slide" id="carousel-homepage-latestnews">
			<div role="listbox" class="carousel-inner">
				<div class="item active" style="height: 396px;">
					<div class="col-sm-3 latestnews-box">
						<div class="latestnews-img">
							<a title="GHR Groups" href="javascript:void(0)" class="latestnews-img-a">
								<img width="250" height="250" sizes="(max-width: 250px) 100vw, 250px" srcset="<?php echo get_site_url(); ?>/wp-content/uploads/2016/07/ghr-150x150.png 150w, <?php echo get_site_url(); ?>/wp-content/uploads/2016/07/ghr-250x250.png 250w, <?php echo get_site_url(); ?>/wp-content/uploads/2016/07/ghr-174x174.png 174w" alt="ghr" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" src="<?php echo get_site_url(); ?>/wp-content/uploads/2016/07/ghr-250x250.png">
								</a>
							</div>
							<div class="white-text latesnews-content">
								<h3 class="latestnews-title">
									<a title="GHR Groups" href="javascript:void(0)">GHR Groups</a>
								</h3>
								<p>This was the website to apply for driving licence after giving the Right answers for test conducted online.</p>
							</div>
						</div>
						<!-- .latestnews-box"> -->
						<div class="col-sm-3 latestnews-box">
							<div class="latestnews-img">
								<a title="SpeedPPC" href="javascript:void(0)" class="latestnews-img-a">
									<img width="250" height="250" sizes="(max-width: 250px) 100vw, 250px" srcset="<?php echo get_site_url(); ?>/wp-content/uploads/2016/07/speed2-1-150x150.png 150w, <?php echo get_site_url(); ?>/wp-content/uploads/2016/07/speed2-1-250x250.png 250w, <?php echo get_site_url(); ?>/wp-content/uploads/2016/07/speed2-1-174x174.png 174w" alt="speed2" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" src="<?php echo get_site_url(); ?>/wp-content/uploads/2016/07/speed2-1-250x250.png">
									</a>
								</div>
								<div class="latesnews-content">
									<h3 class="white-text latestnews-title">
										<a title="SpeedPPC" href="javascript:void(0)">SpeedPPC</a>
									</h3>
									<p>There was a plugin where you can manage the Pay per click methods on defined kewords for diffrent search engines</p>
								</div>
							</div>
							<!-- .latestnews-box"> -->
							<div class="col-sm-3 latestnews-box">
								<div class="latestnews-img">
									<a title="UkGraded" href="javascript:void(0)" class="latestnews-img-a">
										<img width="250" height="250" sizes="(max-width: 250px) 100vw, 250px" srcset="<?php echo get_site_url(); ?>/wp-content/uploads/2016/07/ukgraded-1-150x150.png 150w, <?php echo get_site_url(); ?>/wp-content/uploads/2016/07/ukgraded-1-250x250.png 250w, <?php echo get_site_url(); ?>/wp-content/uploads/2016/07/ukgraded-1-174x174.png 174w" alt="ukgraded" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" src="<?php echo get_site_url(); ?>/wp-content/uploads/2016/07/ukgraded-1-250x250.png">
										</a>
									</div>
									<div class="latesnews-content">
										<h3 class="white-text latestnews-title">
											<a title="UkGraded" href="javascript:void(0)">UkGraded</a>
										</h3>
										<p>This was an e-comerece website based on home appliances</p>
									</div>
								</div>
								<!-- .latestnews-box"> -->
								<div class="col-sm-3 latestnews-box">
									<div class="latestnews-img">
										<a title="seek" href="javascript:void(0)" class="latestnews-img-a">
											<img width="250" height="250" sizes="(max-width: 250px) 100vw, 250px" srcset="<?php echo get_site_url(); ?>/wp-content/uploads/2016/07/seek2-1-150x150.png 150w, <?php echo get_site_url(); ?>/wp-content/uploads/2016/07/seek2-1-250x250.png 250w, <?php echo get_site_url(); ?>/wp-content/uploads/2016/07/seek2-1-174x174.png 174w" alt="seek2" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" src="<?php echo get_site_url(); ?>/wp-content/uploads/2016/07/seek2-1-250x250.png">
											</a>
										</div>
										<div class="latesnews-content">
											<h3 class="white-text latestnews-title">
												<a title="seek" href="javascript:void(0)">seek</a>
											</h3>
											<p>This was an job portal website for candidates seeking for online jobs</p>
										</div>
									</div>
									<!-- .latestnews-box"> -->
									<div class="clear"></div>
...
<!-- custom section  for projects  ends-->
